...
def _run_checks(now: datetime) -> tuple[list[str], dict[str, str], int, int]:
    ...
    Returns (problems, kill_switches, checks_run, checks_failed, reconciliation)."""
    registry = _registry()
    problems: list[str] = []
    kill_switches: dict[str, str] = {}
    checks_run = 0
    ...
    return problems, kill_switches, checks_run, checks_failed, reconciliation
...
def handler(event: dict, context) -> dict:  # noqa: ARG001 — Lambda contract
    ...
    problems, kill_switches, checks_run, checks_failed, reconciliation = _run_checks(now)
