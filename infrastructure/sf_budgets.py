...
STAGE_BUDGETS: dict[str, StageBudget] = {
    ...
    # MorningEnrich (5_400) and DataPhase1 (6_600, measured 2388-5018 s over
    # 2026-08-01..22, alpha-engine-config-I9201) left this table with the
    # decoupled data cutover (alpha-engine-config-I11269): the standalone
    # ne-data-collection-weekly runs that work under the dispatcher's own
    # per-workload caps, and the weekly SF now spends a bounded Lambda poll
    # (WaitForCollectionManifests, no SSM executionTimeout) in their place.
